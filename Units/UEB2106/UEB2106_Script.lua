...
local TStationaryLightMaserBeamWeapon = FBPNTWeaponFile.TStationaryLightMaserBeamWeapon


UEB2106 = Class(TStructureUnit) {
    
    Weapons = {
        MaserWeapon = Class(TStationaryLightMaserBeamWeapon) {
        },
